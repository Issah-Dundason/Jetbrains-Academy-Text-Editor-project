...
public class TextEditor extends JFrame {
    ...
    private JPanel createSearchPanel() {
        ...
        ImageIcon prevIcon = new ImageIcon("images/left.png");
        ImageIcon searchIcon = new ImageIcon("images/searching.png");
        ...
        JLabel checkBoxLabel = new JLabel("User regex");
    ...
    private void setCaretPosition(MatchedGroup matchedGroup) {
       // System.out.printf("%d %d", matchedGroup.getStartIndex(), matchedGroup.getEndIndex());
